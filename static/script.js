...
function updateStatusTable(status) {
    document.getElementById('altitude').innerText = status.altitude.toFixed(2);
    document.getElementById('speed').innerText = status.speed.toFixed(1);
    document.getElementById('battery').innerText = `${status.battery}%`;
    document.getElementById('gps').innerText = status.gps;
    document.getElementById('signal_strength').innerText = `${status.signal_strength} dBm`;
